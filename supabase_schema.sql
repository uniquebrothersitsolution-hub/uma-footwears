...
create table if not exists public.shop_settings (
  ...
  ledger_columns jsonb default '["billNoDate","pNo","articleNo","mrp","brand","type","wholeSalePct","wholeSaleValue","sizeAvailable","payment"]'::jsonb,
...
alter table public.shop_settings add column if not exists ledger_columns jsonb default '["billNoDate","pNo","articleNo","mrp","brand","type","wholeSalePct","wholeSaleValue","sizeAvailable","payment"]'::jsonb;
...
SET
  ledger_columns = '["billNoDate","pNo","articleNo","mrp","brand","type","wholeSalePct","wholeSaleValue","sizeAvailable","payment"]'::jsonb,
  column_labels = '{}'::jsonb,
  updated_at = now()
WHERE id = 1;
